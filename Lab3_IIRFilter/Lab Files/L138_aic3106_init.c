/*
  Info: $Id: L138_aic3106_init.c 756 2014-02-04 22:15:04Z scott $   USU
  Revision: $Rev: 756 $
 $LastChangedDate: 2014-02-04 15:15:04 -0700 (Tue, 04 Feb 2014) $
 $LastChangedBy: scott $
...
//*EDMA3_PaRAM_ptr++ = (int32_t)((((BUFCOUNT/2)<<16) & 0xFFFF0000) | 0x00000800); // reload BCNT with BUFCOUNT/2 and link to PaRAM set 64
*EDMA3_PaRAM_ptr++ = 0x00000800; // reload BCNT with BUFCOUNT/2 and link to PaRAM set 64
...
//*EDMA3_PaRAM_ptr++ = (int32_t)((((BUFCOUNT/2)<<16) & 0xFFFF0000) | 0x00000820); // reload BCNT with BUFCOUNT/2 and link to PaRAM set 64
*EDMA3_PaRAM_ptr++ = 0x00000820; // reload BCNT with BUFCOUNT/2 and link to PaRAM set 64
...
//*EDMA3_PaRAM_ptr++ = (int32_t)((((BUFCOUNT/2)<<16) & 0xFFFF0000) | 0x00000860); // reload BCNT with BUFCOUNT/2 and link to PaRAM set 67
*EDMA3_PaRAM_ptr++ = 0x00000860; // reload BCNT with BUFCOUNT/2 and link to PaRAM set 67
*EDMA3_PaRAM_ptr++ = 0x00000000; // 
*EDMA3_PaRAM_ptr++ = 0x00000001; // rsvd, CCNT 1 frame per block
...
*EDMA3_PaRAM_ptr++ = (int32_t)((((BUFCOUNT/2)<<16) & 0xFFFF0000) | 0x00000880); // reload BCNT with BUFCOUNT/2 and link to PaRAM set 68
*EDMA3_PaRAM_ptr++ = 0x00000000; // 
...
*EDMA3_PaRAM_ptr++ = 0x00040000; // DSTBIDX, SRCBIDX
*EDMA3_PaRAM_ptr++ = (int32_t)((((BUFCOUNT/2)<<16) & 0xFFFF0000) | 0x00000860); // reload BCNT with BUFCOUNT/2 and link to PaRAM set 69
*EDMA3_PaRAM_ptr++ = 0x00000000; // 
*EDMA3_PaRAM_ptr++ = 0x00000001; // rsvd, CCNT
...
void L138_initialise_edma(int32_t fs, int16_t adc_gain, int16_t dac_atten)
{
...
void L138_initialise_poll(int32_t fs, int16_t adc_gain, int16_t dac_atten)
{
...
void L138_initialise_intr(int32_t fs, int16_t adc_gain, int16_t dac_atten)
{
